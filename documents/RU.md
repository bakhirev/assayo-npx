...
**Ссылки:** [demo](https://assayo.online/demo/?ref=github&lang=en&dump=./test.txt), [online version](https://assayo.online/demo/?ref=github), [docker](https://hub.docker.com/r/bakhirev/assayo), [reddit](https://www.reddit.com/r/ITManagers/comments/1e5k291/the_visualization_and_analysis_of_git_commit/), [habr](https://habr.com/ru/articles/763342/), [video](https://www.youtube.com/watch?v=mqfu-ea3jao).

**Основное приложение:** [github](https://github.com/bakhirev/assayo), [website](https://assayo.online/)
...
Публикация:
1. требует токен;
2. может случайно отваливаться;
3. работает только из командной строки Windows;
```
